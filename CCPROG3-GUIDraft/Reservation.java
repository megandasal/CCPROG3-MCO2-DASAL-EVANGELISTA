...
public class Reservation {
    ...
    public void printReservationInformation() {
        ...
        System.out.format("| Discount Code: $%-14s |\n", this.coupon);
        ...
        switch (discountCode) {
            ...
            case "STAY4_GET1":
                if (this.checkOutDate - this.checkInDate >= 4) { // 5 days or 4 nights
                    this.totalPrice = this.totalPrice - (this.roomPrice * ((double) this.priceModifierDatabase[checkInDate-1] / 100.0));
                    System.out.println(this.priceModifierDatabase[checkInDate-1] + " was subtracted!");
